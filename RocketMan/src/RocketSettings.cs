    ...
    public class RocketMod : Mod
    {
        ...
        public static void DoSettings(Rect inRect, bool doStats = true, Action<Listing_Standard> extras = null)
        {
            ...
            if (Finder.enabled)
            {
                ...
                listing.Label(string.Format("Resource readout expiry is {0} ticks", Finder.resourceReadOutCacheAge));
                Finder.resourceReadOutCacheAge = (int)listing.Slider(Finder.resourceReadOutCacheAge, 30, 250);
